...
const colors = {
  ...
  accent: { emerald: '#7c9a6d', emeraldLight: '#c5d4be', sage: '#9db88c', sageLight: '#c5d4be', terracotta: '#c49a84', terracottaLight: '#e8d8cc' }
};
    ...
    <AuthenticatedLayout>
      ...
      <div className="relative min-h-screen">
        <header className="sticky top-0 z-30 px-4 h-14 flex items-center justify-between" style={{ backgroundColor: colors.bg, borderBottom: `1px solid rgba(61, 58, 54, 0.06)` }}>
          <span className="text-sm tracking-wide" style={{ color: colors.text.secondary }}>Men Married</span>
          <div className="flex items-center gap-3">
            <Link href="/married/women" className="text-xs px-3 py-1.5 rounded-full transition-colors" style={{ backgroundColor: colors.surface, color: colors.text.secondary }}>Women</Link>
            <SignedIn><UserButton /></SignedIn>
          </div>
        </header>
        <main className="max-w-2xl mx-auto px-5 py-8 pb-24">
          <div className="rounded-2xl p-5 mb-6" style={{ backgroundColor: colors.accent.emerald }}>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between gap-2">
                <button
                  ...
                  style={{
                    backgroundColor: filterFrequent ? colors.accent.emeraldLight : colors.surface,
                    color: filterFrequent ? colors.accent.emerald : colors.text.secondary,
                    fontWeight: filterFrequent ? 500 : 400
                  }}
                >
                  <span>Attended 3+ times (3mo)</span>
                  {filterFrequent && (
                    <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: colors.accent.emerald }} />
                  )}
                </button>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-1 space-y-0.5">
                          ...
                          {member.past3MonthsAttendanceCount !== undefined && (
                            <div className="text-xs flex items-center gap-1" style={{ color: colors.accent.emerald, fontWeight: 500 }}>
                    ...
                    {trends.map((day) => (
                      <div key={day.date} className="flex items-center gap-3">
                        ...
                        <div className="flex-1 h-2 rounded-full overflow-hidden" style={{ backgroundColor: colors.surfaceHover }}>
                          <div className="h-full rounded-full transition-all" style={{ width: `${day.rate}%`, backgroundColor: colors.accent.emerald }} />
                        </div>

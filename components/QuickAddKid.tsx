          ...
          <div className="relative z-[10000] w-full max-w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl overflow-hidden max-h-[90vh] flex flex-col" style={{ backgroundColor: colors.surface }}>
            ...
            <form onSubmit={submit} className="flex-1 overflow-y-auto p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <input value={contact} onChange={(e) => setContact(e.target.value)} placeholder="Parent's phone" className="w-full min-w-0 px-3 py-2.5 rounded-xl text-sm outline-none" style={{ backgroundColor: colors.bg, color: colors.text.primary }} />
                <input type="number" min="0" max="150" value={age} onChange={(e) => setAge(e.target.value)} placeholder="Age" className="w-full min-w-0 px-3 py-2.5 rounded-xl text-sm outline-none" style={{ backgroundColor: colors.bg, color: colors.text.primary }} />
              </div>
